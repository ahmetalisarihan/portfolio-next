...
export const metadata: Metadata = {
  title: "Contact - Ahmet Ali SARIHAN",
};
      ...
      <section className="max-width section-padding">
        <div className="box text-center flex flex-col items-center gap-3">
          ...
          <p className="text-grey-600">
            ...
            perferendis est nobis culpa ipsam.
          </p>
        </div>
      </section>
        ...
        <div className="tablet:max-w-md w-full">
          <div className="space-y-4">
            <div className="box !p-6">
              ...
              <h6 className="text-grey-700">ahmetalisarihan@gmail.com</h6>
            </div>
            <div className="box !p-6">
              <p className="text-grey-600">Give Me a Call on</p>
              <h6 className="text-grey-700">+90 533 159 76 00</h6>
            </div>
            <div className="box !p-6">
              <p className="text-grey-600">Location</p>
              <h6 className="text-grey-700">Fethiye/Muğla</h6>
            </div>
          </div>
